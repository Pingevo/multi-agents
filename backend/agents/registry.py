...
class AgentRegistry:
    ...
    def add_agent(self, spec: dict) -> dict:
        ...
        agent = {
            ...
            "review_iterations": spec.get("review_iterations", 0),
            "max_iter": spec.get("max_iter", 0),
            "max_retry_limit": spec.get("max_retry_limit", 0),
    ...
    def to_spec(self, agent: dict) -> dict:
        ...
        return {
            ...
            "review_iterations": agent.get("review_iterations", 0),
            "max_iter": agent.get("max_iter", 0),
            "max_retry_limit": agent.get("max_retry_limit", 0),
