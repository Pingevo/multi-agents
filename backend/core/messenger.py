        ...
        for cat, models in recommended.items():
            rec_items[cat] = [
                ModelCatalogItem(
                    ...
                    image_price=m.get("image_price", "?"),
                    image_output_price=m.get("image_output_price", "?"),
                    video_price=m.get("video_price", "?"),
                    video_output_price=m.get("video_output_price", "?"),
                    audio_price=m.get("audio_price", "?"),
                    web_search_price=m.get("web_search_price", "?"),
